                  ...
                  <TooltipProvider delayDuration={0}>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          ...
                          onClick={(e) => {
                            ...
                            const tooltip = document.querySelector('[data-state="closed"][data-radix-tooltip-content]')
                            if (tooltip) {
                      ...
                      <TooltipContent side="right" sideOffset={5} className="max-w-xs">
                        <p>
                          For the sample workflow from the paper, this is fixed at 9 tasks with predefined runtimes and
                          dependencies.
                        </p>
                      </TooltipContent>
                    </Tooltip>
              ...
              {selectedWorkflow === "sample" && (
                <div className="mt-4 p-4 bg-blue-50 rounded-md">
                  ...
                  <p className="text-xs text-gray-600">
                    This is the exact workflow from the DSAWS paper with 9 tasks (t1-t9) scheduled across 3 VMs. Each
                    task has a specific runtime and rank value as defined in the paper.
                  </p>
